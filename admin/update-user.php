...
$fmobile=$_POST['mobilenumber'];	
$femail=$_POST['emailid'];
$fpassword=$_POST['password'];	

$sql="update Tblusers set FullName=:fname,MobileNumber=:fmobile,EmailId=:femail,Password=:fpassword, where id=:pid";
$query = $dbh->prepare($sql);
$query->bindParam(':fname',$fname,PDO::PARAM_STR);
$query->bindParam(':fmobile',$fmobile,PDO::PARAM_STR);
$query->bindParam(':femail',$femail,PDO::PARAM_STR);
$query->bindParam(':fpassword',$fpassword,PDO::PARAM_STR);
