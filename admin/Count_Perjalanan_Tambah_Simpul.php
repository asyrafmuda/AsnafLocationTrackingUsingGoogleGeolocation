<?php
class Count_Perjalanan_Tambah_Simpul extends DistanceTo{

	public function Count_Perjalanan_Tambah_Simpul($index, $limit, $jArrCoordinates){		
		...
		if($index == $limit){
			...
			// simpan jarak
			// @extends
			$perjalanan += $this->distanceTo($lat_0, $lng_0, $lat_1, $lng_1);
		}else{
			for($i = 0; $i < 1; $i++){
